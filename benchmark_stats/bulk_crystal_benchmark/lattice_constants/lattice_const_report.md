...
| Model                   |   Lat Const MAE [Å] |   Lat Const Score ↓ |   Rank |
|:------------------------|--------------------:|--------------------:|-------:|
| mace_mp_0a_D3           |               0.027 |               1     |      2 |
| mace_mp_0b3_D3          |               0.027 |               1     |      2 |
| mace_mpa_0_D3           |               0.019 |               0.704 |      1 |
| mace_omat_0_D3          |               0.084 |               3.111 |      6 |
| mace_matpes_PBE_0_D3    |               0.035 |               1.296 |      4 |
| mace_matpes_r2scan_0_D3 |               0.044 |               1.63  |      5 |
